      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-3">
            <Link to="/login" className="inline-flex items-center gap-2 rounded-md border border-slate-300 px-3 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50">
              <User className="h-4 w-4" /> Login
            </Link>
            <Link to="/register/user" className="inline-flex items-center rounded-md bg-slate-900 px-3 py-2 text-sm font-medium text-white hover:bg-slate-800">
              Get Started
            </Link>
          </div>
        ...
        {open && (
          <div className="md:hidden pb-4">
            <div className="flex flex-col gap-2">
              ...
              <Link to="/login" className="rounded-md px-3 py-2 text-slate-700 hover:bg-slate-100">Login</Link>
              <Link to="/register/user" className="rounded-md px-3 py-2 text-white bg-slate-900 hover:bg-slate-800">Get Started</Link>
            </div>
          </div>
        )}
      </div>
